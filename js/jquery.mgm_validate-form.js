          ...
          <span class="loading-text" style="color:#FF4040;">' + qs_mess + '</span>');
                ...
                if (option.cm === true) {
                    ...
                    if (nCl > 0) {
                        ...
                        if (nCl === 3) {
                            var cm3 = parseInt($('input:radio[name=fc-cm-3]:checked').prop('value'));
                            if (cm3 === 1) {
                                k = j = 0;
                                $(".cb-qs-3").each(function() {
                                    if ($(this).is(':checked')) {
                                        val_qs = $(this).attr("value");
                                        data_03[k] = 'Y|' + val_qs;
                                        if ($(this).hasClass('txtarea') === true) {
                                            data_obs_03[j] = val_qs + '|' + $("#fc-obs-3-" + val_qs).prop('value');
                                            j += 1;
                                        }
                                    } else {
                                        data_03[k] = 'N|' + $(this).attr("value");
                                    }
                                    k += 1;
                                });
            ...
            function validateElementType(element, err) {
                ...
                if ($(element).hasClass('number') === true) {
                    ...
                    regex = /^[a-zA-Zá�?éÉí�?óÓúÚñÑüÜ\s]*$/;
                    err = 'Ingrese solo texto';
                } else if ($(element).hasClass('text-2') === true) {
                    regex = /^[a-zA-Z0-9á�?éÉí�?óÓúÚñÑüÜ\s\-]*$/;
                    err = 'Ingrese solo texto';
