...
class CertificateSibas extends CertificateQuery {
    ...
    public function __construct($ide, $idc, $idcia, $product, $type, $category, $page, $nCopy, $implant, $fac = FALSE, $reason = '') {
    ...
    private function _ATTACHED() {
        ...
        try {
            ...
            $mail->Host = 'diaconia-frif@abrenet.com';
            $mail->From = 'diaconia-frif@abrenet.com';
            $mail->FromName = $this->rowPo['ef_nombre'];
    ...
    private function get_content_html() {
        ...
        if ($this->category === 'SC' || $this->category === 'PES' || $this->product === 'TH') {
            echo '<a href="certificate-detail.php?idc='
            ...
            echo '<a href="certificate-detail.php?ide='
