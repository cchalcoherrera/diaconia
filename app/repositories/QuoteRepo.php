...
class QuoteRepo {
    ...
    public function getResultQuoteData($idc, $idef, $numero_titulares) {
        $data = array();
        ...
        $sql = 'select 
			...
			st.tasa_final as t_tasa_final,
                        st.tasa_final_mancomunado as t_tasa_final_mancomunado,
			sdc.modalidad,
    ...
    public function getResultTitularesData($idc) {
