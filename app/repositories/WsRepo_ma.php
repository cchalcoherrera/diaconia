...
class WsRepo
{
	...
	$this->host = 'http://10.80.80.12';
        //$this->host = 'http://localhost/producto/';
        $this->ws  = $ws;
        $this->bc  = $bc;
        $this->dni = $dni;
    }
    ...
    private function dataClientDB()
    {
        ...
        if (( $rs = $this->cx->query($sql, MYSQLI_STORE_RESULT) ) !== false) {
            ...
            $this->data['error']  = 'La conexión a fallado.1';
        }
    }
    ...
    private function dataClientWS()
    {
        ...
        if (( $res = file_get_contents($this->host) ) !== false) {
            ...
            if (is_array($json)) {
                ...
                $this->data['status'] = 452;
                $this->data['error']  = 'La conexión a fallado2.';
            }
        }
    }
