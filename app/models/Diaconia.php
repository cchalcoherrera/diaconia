...
class Diaconia
{
    ...
    public function getDataProduct($idef, $product = 'DE')
    {
        ...
        public function getDataProductHip($idef, $product = 'DE')
    {
        $sql = 'select 
            sh.edad_min_hip as edad_min,
            sh.edad_max_hip as edad_max,
            sh.max_detalle,
            sh.max_emision_bs_hip as max_emision_bs,
            sh.max_emision_usd_hip as max_emision_usd,
            sh.web_service as ws,
            sh.data_hip as data
        from 
            s_sgc_home as sh
