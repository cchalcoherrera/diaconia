<?php
  ...
  if($_POST['opcion']=='certmedico'){
	 ...
	 if($flag === TRUE){
	  ...
	  if($_REQUEST['hipotecario']=="si"){
               $update = "UPDATE s_sgc_home SET data_hip='".$conexion->real_escape_string(json_encode($data))."' WHERE id_home='".base64_decode($_POST['idhome'])."' and id_ef='".base64_decode($_POST['id_ef'])."' LIMIT 1;";
          }else{
