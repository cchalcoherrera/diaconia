    ...
    ;";
        ...
        if ($rs->num_rows > 0) {
            ...
            <tbody>
                ...
                sdd.detalle_f,
                sdd.detalle_p,
                (SELECT COUNT(*) FROM s_de_em_detalle as sdd2 WHERE sdd2.facultativo=1 AND sdd2.id_emision=sdd.id_emision) as cantidad_facultativo
            from
                s_cliente as sdc
                    inner join
            ...
            ;";
                    ...
                    if ($nDt <= $nCl) {
                        ...
                        while ($rowCl = $rsCl->fetch_array(MYSQLI_ASSOC)) {
                            ...
                            if ($bc == 2) {
                                $nDt = $rowCl['cantidad_facultativo'];
                            }
                        ...
                        ?>
                                    ...
                                    <td <?= $rowSpan; ?>><?= $data_coverage[(int) $row['bc']]; ?></td>
                                          <td <?= $rowSpan; ?>><?= $row['producto_cia']; ?></td>
                                    <?php
