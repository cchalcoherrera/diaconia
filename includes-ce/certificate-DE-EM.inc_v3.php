...
function de_em_certificate_v3($link, $row, $rsDt, $url, $implant, $type, $fac, $reason = '') {
                        ...
                        <table 
                            ...
                            <tr>
                                <td style="width:100%; font-weight:bold; text-align:center; font-size: 80%;">
                                    DECLARACIÓN JURADA DE SALUD Nºs <?= $row['no_emision']; ?>
                    ...
                    <div style="width: 775px; border: 0px solid #FFFF00;">
                                    ...
                                    <tr> 
                                        <td style="width:100%; padding-bottom:4px;">
                                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size: 100%;">
                                                <tr>
                                                    <td style="width:13%;">Nombre Completo: </td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                                                <tr>
                                                    ...
                                                    <td style="width:93%; border-bottom: 1px solid #333;">
                                                        <?php
                                                        $po = strpos($rowcl['ocupacion'], '-');
                                                        $fi = strlen($rowcl['ocupacion'])
                                                        ?>
                                                        <?= substr($rowcl['ocupacion'], $po + 1, $fi); ?>
                                                    </td> 
                                                </tr> 
                                            </table>
                                        </td>     
                        ...
                        <table 
                            ...
                            <tr>
                                ...
                                <td style="width:30%; border-bottom: 1px solid #333;">
                                    <?= $row['nombre_agencia'] . " " . $row['fecha_emision']; ?>
                                </td>
                                    ...
                                    <td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                                            <tr>
                                                ...
                                                <td style="width:98%;">
                                                    <b>CONTRATANTE Y BENEFICIARIO A TITULO ONEROSO</b>&nbsp;Fundación Diaconia - Fondo Rotativo de Inversión y Fomento
                                                </td>
                                            </tr>
                                            <tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" 
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 70%;">Desde los 15 años hasta los 73   años (hasta un día 
                                                                            antes    de cumplir 74 años)<br>Máxima 74 años (hasta un día antes de 
                                                                            cumplir 75 años)</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                ...
                                                <td style="width:98%;" align="left">
                                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                                                        <tr>
                                                            ...
                                                            <td style="width:90%;">-Para edades entre 15 a 49 años aplicable solo para creditos 
                                                                mayores  a $us. 8017.63</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:10%;"></td>
                                                            <td style="width:90%;">-Para edades entre 50 a 64 años   aplicable   solo para creditos 
                                                                mayores  a $us.  5831.04</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:10%;"></td>
                                                            <td style="width:90%;">-Para edades entre 65 a 70 años   aplicable   solo para creditos 
                                                                mayores  a $us.  5831.04</td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:98%; text-align:justify;">
                                                    <b>TASA MENSUAL:</b><br>
                                                    Tasa Total Mensual: 0.55% o por mil mensual para creditos individuales y banca comunal, 0.76 por mil mensual para creditos mancomunos, ésta tasa puede variar de acuerdo al tipo de crédito, al riesgo particular que represente el asegurado y/o a las renovaciones futuras de la póliza.
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:98%; text-align:justify;">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                                                        ...
                                                        <tr>
                                                            <td style="width:2%; font-weight:bold;" valign="top">-</td>
                                                            <td style="width:98%;">Certificado Médico único   de  Defunción - Fotocopia simple. Para edades entre 15 a 49 años y creditos mayores a $us. 8017.63 -Para edades entre 50 a 70 años y creditos mayores a $us. 5831.04 </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:2%; font-weight:bold;" valign="top">-</td>
                                                            <td style="width:98%;">Historial Clínica, si corresponde (Para casos de muerte natural) -Para edades entre 15 a 49 años y creditos mayores a $us. 8017.63    -Para edades entre 50 a 70 años y creditos mayores a $us. 5831.04 </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:2%; font-weight:bold;" valign="top">-</td>
                                                            <td style="width:98%;">Informe de la autoridad competente (Para casos de muerte accidental) -Para edades entre 15 a 49 años y creditos mayores a $us. 8017.63 -Para edades entre 50 a 70 años y creditos mayores a $us. 5831.04</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:2%; font-weight:bold;" valign="top">-</td>
                                                            <td style="width:98%;">Declaración Jurada de Salud - Para edades entre 15 a 49 años y creditos mayores a $us. 8017.63 - Para edades entre 50 a 70 años y creditos mayores a $us. 5831.04</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:98%;">Historial clínico O en SU defecto UH informe médico- Para edades 
                                                                entre 15 a 49 años y creditos mayores a $us. 8017.63 -   Para edades entre 50 a 70 años 
                                                                y creditos mayores a $us. 5831.04</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:2%; font-weight:bold;" valign="top">-</td>
                                                            <td style="width:98%;">Declaración Jurada de Salud- Para edades entre 15 a 49 años y 
                                                                creditos mayores a $us. 8017.63 - Para edades entre 50 a 70 años y creditos mayores a 
                                                                $us. 5831.04</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="width:100%; text-align:justify; font-size:80%;">
                                                    ...
                                                    EXCEPCION DE LA PREGUNTA 1). PARA AMBOS CASOS SE INICIARA LA COBERTURA DE SEGURO A PARTIR DE 
                                            ...
                                            <td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                                                    <tr>
                                                        <td style="width:2%; font-weight:bold;">1.</td>
                                                        <td style="width:98%;">
                                                            <b>CONTRATANTE Y BENEFICIARIO A T�?TULO ONEROSO</b>&nbsp;Fundación Diaconia - Fondo Rotativo de Inversión y Fomento
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:2%; font-weight:bold;" valign="top">2.</td>
