...
function de_em_certificate_hip_ant($link, $row, $rsDt, $url, $implant, $type, $fac, $reason = '') {
                                                                        ...
                                                                        <td style="width: 29%; text-align: left;">
                                                                            ...
                                                                            if ($rsDt->data_seek(0)) {
                                                                                while ($rowcl = $rsDt->fetch_array(MYSQLI_ASSOC)) {
                                                                                    ...
                                                                                    echo $rowcl['nombre_completo'] . $coma;
                                                                                }
                                                                            }
                                                                            ?>
                                                                        </td>
                                ...
                                <table 
                                    ...
                                    <tr>
                                        <td style="width:100%; font-weight:bold; text-align:center; font-size: 80%;">
                                            ...
                                            <br />PARA DESGRAVAMEN HIPOTECARIO
                                        </td> 
                                    </tr>
                                </table>     
                            </div>
