...
function de_em_certificate_v1($link, $row, $rsDt, $url, $implant, $type, $fac, $reason = '') {
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:98%; text-align:justify;">
                                                    <b>TASA MENSUAL:</b><br>
                                                    Tasa Total Mensual: 0.50 por mil mensual para creditos individuales y banca comunal, 0.722 por mil mensual para creditos mancomunos, ésta tasa puede variar de acuerdo al tipo de crédito, al riesgo particular que represente el asegurado y/o a las renovaciones futuras de la póliza.
                                                </td>
                                            </tr>
                                            <tr>
