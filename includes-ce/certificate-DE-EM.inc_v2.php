...
function de_em_certificate_v2($link, $row, $rsDt, $url, $implant, $type, $fac, $reason = '') {
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                                                            ...
                                                            <td style="width: 97%;">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" 
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 70%;">Desde los 15 años hasta los 74   años (hasta un día 
                                                                            antes    de cumplir 75 años)<br>Máxima 74 años (hasta un día antes de 
                                                                            cumplir 75 años)</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:98%; text-align:justify;">
                                                    ...
                                                    contra la firma del finiquito correspondiente.<br>
                                                    No seran amparados todos aquellos reclamos por muerte natural o invalidez que ocurriesen antes de los 90 dias de periodo de carencia establecidos desde la fecha de desembolso del prestamo.
                                                </td>
                                            </tr>
                                            <tr>
