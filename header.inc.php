...
if (!isset($_GET['c-p'])) {
    ...
    <?php
    $tokenM = $token;
    get_menu($user_type, $tokenM, $link, $user);
    ?>
                    <!--
                    --><ul id="user-menu">
...
function get_menu($user_type, $tokenM, $link, $user) {
    ?>
            <ul id="main-menu">
    ...
    ?>
                ...
                if ($tokenM === TRUE) {
                    if ($user_type === 'ROOT' || $user_type === 'LOG' || $user_type === 'REP' || $user_type === 'FAC') {
                        if ($user == 'cchalcoop') {
                            ?>
                            <li><a href="#">Acciones Comunes</a>
                                <ul>
                <?php
                /* <li><a href="index.php?ms=<?=md5('MS_REP');?>&page=<?=md5('P_general_prop');?>">Consolidado Aseguradora</a></li> */
                ?>
                                    <li><a href="index.php?ms=<?= md5('MS_EDI'); ?>&page=<?= md5('P_general'); ?>">Edicion de Polizas </a></li>
                                    <?php
                                    ?>
                                </ul>
                            </li>
